...
<template>
  <main class="w-auto" data-aos="fade-in">
    <section class="h-screen p-5 w-full bg-dark-400">
      ...
      <div class="p-5">
        <div class="text-white grid-cols-3 grid gap-5">
          <a
        ...
        <div class="flex-wrap flex col-span-4" data-aos="fade-down">
          <a
            href="/storage/new"
            class="flex flex-wrap text-center py-5 hover:bg-brew w-full hover:text-white duration-300 cursor-pointer justify-center items-center text-3xl bg-dark-300"
          >
