      ...
      <div class="px-5 mt-10">
        <div class="grid-cols-4 grid gap-5">
          ...
          <div class="flex-wrap flex col-span-4" data-aos="fade-down">
            <a
              href="/proxy/new"
              class="flex flex-wrap text-center py-5 hover:bg-brew-500 w-full hover:text-white duration-300 cursor-pointer justify-center items-center text-3xl bg-dark-300"
            >
